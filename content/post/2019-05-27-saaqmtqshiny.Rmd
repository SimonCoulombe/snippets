...
Finalement, j'ai créé une application pour vous permettre de générer le top 10 de votre ville.  Elle est située au shiny.simoncoulombe.com/shiny/saaqmtq.  Le username est "guest" et le mot de passe est "room". 

Voici un screenshot de l'application telle quelle:  

![](/post/2019-05-27-saaqmtqshiny_files/gatineau.png)

Le code pour préparer les données est disponible sur mon [github](https://github.com/SimonCoulombe/saaqmtq).  Les données géocodées sont disponibles en ligne, au cas où vous voudriez y jeter un coup d'oeil.  
