...
Hey,
Just having some fun with gganimate and some fertility data from Statistics Canada.  



# The data   

* Fertility data from Statistics Canada, year 1921-2016  

# The code  

As usual, the code is on  [my github](https://github.com/SimonCoulombe/snippets).  It is heavily inspired by [this blog post by Michael Toth](https://www.r-bloggers.com/how-to-create-a-bar-chart-race-in-r-mapping-united-states-city-population-1790-2010/)
...
#animate(p, nframes = 750, fps = 25, end_pause = 50)
```
