...
dir.create(file.path(here::here("static/post/"), "2019-04-24-montreal-melting-pot_files"), showWarnings = FALSE)
```
...
ggplot() + 
  ...
  ggsave(filename=  here::here("static/post/2019-04-24-montreal-melting-pot_files" , "place_of_birth_quebec.png"),width=11,height=11) 
