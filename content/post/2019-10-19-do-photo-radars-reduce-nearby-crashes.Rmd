...
utils::unzip(here::here("content/post/data/downloads/accidents_2012_2018.zip"), exdir = here::here("content/post/data/interim"))

utils::unzip(here::here("content/post/data/downloads/resultat_TQ.zip"),  exdir = here::here("content/post/data/interim"))
```

```{r, include = F}

accidents <- read_sf(here::here("content/post/data/interim/accidents_2012_2018/accidents_2012_2018.shp")) %>%
...
radars <- read_sf(here::here("content/post/data/interim/radars_photos.shp")) %>% 
