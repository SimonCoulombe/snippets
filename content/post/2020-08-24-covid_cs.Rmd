...
cases_cs %>% 
  ...
  labs(
    title = "Nombre de cas par 1 million d'habitant au cours des 7 derniers jours",
    subtitle = "Selon le critère établi par le ministre Dubé, la courbe est aplatie sour 20 cas / million",
