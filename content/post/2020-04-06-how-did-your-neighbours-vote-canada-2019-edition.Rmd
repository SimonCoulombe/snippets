...
poll_results <- read_rds(here::here("content/post/data/interim/poll_results.rds"))
poll_pop_shp <- read_rds(here::here("content/post/data/interim/poll_pop_shp.rds"))
poll_shp_simple <- read_sf(here::here("content/post/data/interim/simple_election.shp"))
shp_pr <- read_sf(here::here("content/post/data/interim/shp_pr.shp"))
...
write_rds(poll_shp, here::here("content/post/data/interim/poll_shp.rds")
poll_shp <- read_rds(here::here("content/post/data/interim/poll_shp.rds")
...
st_write(poll_shp_simple, here::here("content/post/data/interim/simple_election.shp"), delete_dsn= TRUE)
poll_shp_simple <- read_sf(here::here("content/post/data/interim/simple_election.shp"))
```
...
st_write(shp_pr, here::here("content/post/data/interim/shp_pr.shp"), delete_dsn= TRUE)
...
st_write(shp_pop, here::here("content/post/data/interim/shp_pop.shp"), delete_dsn= TRUE)
# 
...
poll_pop_shp <- poll_pop_shp %>% 
  ...
  st_cast("POLYGON")
write_rds(poll_pop_shp ,here::here("content/post/data/interim/poll_pop_shp.rds"))
poll_pop_shp <- read_rds(here::here("content/post/data/interim/poll_pop_shp.rds"))
...
write_rds(poll_results, here::here("content/post/data/interim/poll_results.rds"))
```
